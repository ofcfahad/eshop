    ...
    return (
        <nav className='w-full fixed bg-primary h-[50px] items-center border-b border-black border-opacity-10 transition-all ease-in delay-100'>
            <div className='flex mt-[-10px]'>
                ...
                {/* SEARCHBAR */}
                <div className='h-full items-center justify-center' onFocus={() => setisextended(true)} onBlur={() => setisextended(false)}>
                    {isextended ? <div className='h-[35px] w-[500px] mt-4 ml-5 transition-transform'>
                        <SearchBar />
                    </div> : <SearchBar
                        type={'SearchButton'}
                    />
